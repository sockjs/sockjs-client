...
gulp.task('browserify:tests', ['testbundle-debug'], function () {
    return browserify('tests/browser.js', { debug: true })
        .bundle()
...
gulp.task('test:client', ['browserify:tests'], function (done) {
    return new karma_ts_1.Server({
